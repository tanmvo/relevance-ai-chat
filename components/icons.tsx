...
export const TrippityIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    style={{ color: "currentcolor" }}
    viewBox="0 0 449 274"
    ...
    fill="none"
  >
    <title>Trippity</title>
    <path
      d="M197.111 0.70381C248.934 -0.886658 294.384 -3.23437 334.294 36.6776C354.052 56.433 366.425 82.372 369.347 110.156C370.46 121 370.101 134.626 370.096 145.715L370.123 196.582C386.626 191.573 405.787 186.484 422.818 184.074C429.337 183.146 439.168 183.082 444.379 187.549C447.227 189.991 447.997 192.395 448.366 196.008C449.02 202.367 444.637 209.545 440.112 213.879C400.465 251.838 301.684 271.096 250.485 272.683C208.813 276.886 145.636 269.061 105.165 258.519C70.4696 248.283 25.6278 236.951 2.73649 206.765C-1.93387 200.606 -0.53672 188.356 6.2444 185.967C25.2734 179.27 59.6131 191.304 78.141 196.551C78.4738 179.075 78.0165 161.292 78.1864 143.787C78.2897 133.109 77.8604 121.98 78.8399 111.346C81.3156 85.1469 92.2207 60.4555 109.919 40.977C133.098 15.3392 162.933 2.44668 197.111 0.70381Z"
      fill="currentColor"
    />
    <path
      d="M78 155 Q224 185 370 155 L370 180 Q224 210 78 180 Z"
